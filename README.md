...
<!-- progress:start -->
**Overall:** 5/10 tasks complete (50%). 0/3 studies fully complete.
**By phase:** Phase 1: 4/8 (50%); Phase 1 (Bonus Track): 1/2 (50%).
...
| Phase 1 (Bonus Track) | Bonus A - Mia & Seb Dinner Fight, La La Land | `#####-----` | 1/2 (50%) | Ways to redesign |
